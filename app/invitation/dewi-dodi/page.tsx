        ...
        <AnimatePresence mode="wait">
          ...
          {open && (
            ...
            >
              ...
              <BrideAndGroom bride={bride} groom={groom} brideImages={gallery.dewi} groomImages={gallery.idot}/>
              <Date date={date.number} images={gallery.date}/>
