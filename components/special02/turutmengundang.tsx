...
export default function TurutMengundang() {
  ...
  return (
    <section  className="h-auto bg-neutral-200 flex items-center justify-center">
      <div className="relative w-full max-w-md h-full overflow-hidden shadow-2xl bg-white">
      ...
      />
      <div className="absolute top-[80px] right-[-200px] z-10 pointer-events-none rotate-[-90deg] animate-[swingingtree2_25s_ease-in-out_infinite_8s]">
        <Image
      ...
      />
        ...
        {/* Content */}
        <div className="relative h-full flex flex-col items-center justify-center text-center text-special02C mt-16 z-50 mb-20">
          <motion.div
            ...
            <div className="flex gap-6 justify-center mb-3">
              <a href="https://api.whatsapp.com/send/?phone=6285150000715&amp;text=Halo,+saya+ingin+tanya+mengenai+Undangan+Website,+saya+mendapatkan+WA+dari+undangan+yang+telah+disebar." target="_blank" rel="nofollow">		
                <svg 
                  ...
                  viewBox="0 0 640 640"
                  className="w-8 h-8 text-special02C hover:scale-110 transition"
                >
                  <path 
                    fill="currentColor" 
