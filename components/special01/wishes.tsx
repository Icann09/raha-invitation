    ...
    <section  className=" bg-neutral-200 flex items-center justify-center h-auto">
      <div className="relative w-full max-w-md h-auto overflow-hidden shadow-2xl bg-white">
        ...
        <Image
          ...
          width={350}
          height={350}
          className="absolute top-6 right-[-20px] transform translate-x-1/2 z-30 pointer-events-none rotate-[-45deg] animate-[swingingtree2_20s_ease-in-out_infinite_5s]"
        />
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-start text-center py-20 z-40">
          ...
          <form action="" className={plusJakartaSans.className + " my-8 items-center justify-center flex flex-col"}  >
            <motion.div
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
            <div className="w-80 h-96 max-w-sm mx-auto bg-special01E/50 rounded-xl p-4 mt-8 text-white text-xs flex flex-col gap-4 overflow-y-auto text-left">
