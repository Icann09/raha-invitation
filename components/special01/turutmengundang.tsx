...
export default function TurutMengundang() {
  ...
  return (
    <section  className="h-auto bg-neutral-200 flex items-center justify-center">
      <div className="relative max-w-md w-full h-full overflow-hidden shadow-2xl bg-white">
        ...
        <Image
          ...
          width={350}
          height={350}
          className="absolute top-6 right-[0px] transform translate-x-1/2 z-30 pointer-events-none rotate-[-45deg] animate-[swingingtree2_20s_ease-in-out_infinite_8s]"
        />
        <div className="absolute bottom-[135px] right-[0px] transform translate-x-1/2 z-30  rotate-[-90deg] animate-[swingingtree2_20s_ease-in-out_infinite_8s]">
          <Image
            src="/images/special01/assets/tree2.webp"
            alt="Tree 1"
            width={250}
        ...
        {/* Content */}
        <div className="relative h-screen flex flex-col items-center justify-center text-center my-16 z-40 ">
          <motion.div
